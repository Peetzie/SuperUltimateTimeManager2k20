...
public class UserJoinProjectController implements Initializable {//controller for join project scene
    ...
    void joinButtonHandler(ActionEvent event) throws IOException {//button for joining a project and returns the to the user interface
        Main.command("joinproject " +  Main.getProjects().indexOf(selectProject.getValue()));
